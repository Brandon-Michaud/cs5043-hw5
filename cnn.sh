...
python hw5_base.py -vv @exp.txt @oscer.txt @rnn.txt --exp_index $SLURM_ARRAY_TASK_ID --cpus_per_task $SLURM_CPUS_PER_TASK --dataset /home/fagg/datasets/pfam --render --nogo
